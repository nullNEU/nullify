...
Safari → Brave (see iOS browser comparison here)
iMessage → Signal
iCloud → Proton Drive
...
Consider using security auditing tools like iVerify to check your device for security vulnerabilities and misconfigurations.
{{< linebreak >}}
...
- Into the Cyberverse - The ultimate list of apps/services for better Security, Privacy and Anonymity
- Personal Safety User Guide for Apple Devices: Apple's official guide is a comprehensive resource for anyone concerned about or experiencing technology-enabled abuse, stalking, or harassment. It offers practical steps to sever digital ties and utilize the built-in safety features of Apple devices.